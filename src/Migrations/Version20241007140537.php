 ...
 */
final class Version20241007140537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_product_description_template_block ADD CONSTRAINT FK_DB8F0A88C361AA95 FOREIGN KEY (productDescriptionTemplateBlock_id) REFERENCES sylius_product_description_template_block (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_product_description_template_block ADD CONSTRAINT FK_DB8F0A88727ACA70 FOREIGN KEY (parent_id) REFERENCES sylius_product_description_template_block (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
