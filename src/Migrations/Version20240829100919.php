 ...
 */
final class Version20240829100919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_taxon ADD CONSTRAINT FK_CFD811CABFAC2C94 FOREIGN KEY (categoryOutfits_id) REFERENCES sylius_category_outfit (id)');
