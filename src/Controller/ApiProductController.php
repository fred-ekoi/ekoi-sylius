...
class ApiProductController extends AbstractController
{
    ...
    public function getProductDescription(int $productId, String $localeIso): JsonResponse
    {
        ...
        $productDescriptionBlocks = $this->productService->buildProductDescriptionBlocks($product, $locale);        

        return new JsonResponse($productDescriptionBlocks);
    }

    public function getProductFeatures(int $productId, String $localeIso): JsonResponse
    {
        $product = $this->productRepository->find($productId);
        ...
        $productProductFeatures = $this->productService->buildProductFeatures($product, $locale);        

        return new JsonResponse($productProductFeatures);
    }

    public function getProductAttributeImage(int $productId): JsonResponse
    {
        $product = $this->productRepository->find($productId);
